/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings src/worker-env.d.ts` (hash: 72ce998ec4e0c21a3ef5ad6ab8baac30)
...
declare namespace Cloudflare {
	...
	interface Env {
		KV: KVNamespace;
		MODE: "local" | "dev" | "prod";
		API_ORIGIN: "http://localhost:8787" | "https://api.dev.vendel.dk" | "https://api.vendel.dk";
		CORS_ORIGINS: "http://localhost:5173" | "https://dev.vendel.dk" | "https://vendel.dk,https://www.vendel.dk";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MODE" | "API_ORIGIN" | "CORS_ORIGINS" | "TOKEN_ENCRYPTION_KEY" | "TOKEN_SIGNING_KEY" | "RESEND_API_KEY" | "TURNSTILE_SECRET_KEY">> {}
}
