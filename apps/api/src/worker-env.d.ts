/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings src/worker-env.d.ts` (hash: 1b6cdb10f379469a58b62400aab0b2fe)
...
declare namespace Cloudflare {
	...
	interface Env {
		KV: KVNamespace;
		MODE: "local" | "dev" | "prod";
		API_ORIGINS: "http://localhost:7100" | "https://api.dev.vendel.dk" | "https://api.vendel.dk,https://api.prod.vendel.dk";
		CORS_ORIGINS: "http://localhost:7000" | "https://dev.vendel.dk" | "https://vendel.dk,https://www.vendel.dk,https://prod.vendel.dk";
