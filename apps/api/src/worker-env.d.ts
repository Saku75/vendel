/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings src/worker-env.d.ts` (hash: 410053e594b4ebe6de0104d258101430)
// Runtime types generated with workerd@1.20260625.1 2025-11-17 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	KV: KVNamespace;
	DB: D1Database;
	ASSETS: Fetcher;
	MODE: "dev" | "prod" | "local";
	API_ORIGINS: "https://api.dev.vendel.dk" | "https://api.vendel.dk,https://api.prod.vendel.dk" | "http://localhost:7100";
	CORS_ORIGINS: "https://dev.vendel.dk" | "https://vendel.dk,https://www.vendel.dk,https://prod.vendel.dk" | "http://localhost:7000";
	COOKIE_PREFIX: "vendel_dev" | "vendel" | "vendel_local";
...
declare namespace Cloudflare {
	...
	interface ProdEnv {
		...
		ASSETS: Fetcher;
		MODE: "prod";
		API_ORIGINS: "https://api.vendel.dk,https://api.prod.vendel.dk";
		CORS_ORIGINS: "https://vendel.dk,https://www.vendel.dk,https://prod.vendel.dk";
		COOKIE_PREFIX: "vendel";
		TOKEN_ENCRYPTION_KEY: string;
		TOKEN_SIGNING_KEY: string;
		RESEND_API_KEY: string;
		TURNSTILE_SECRET_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MODE" | "API_ORIGINS" | "CORS_ORIGINS" | "COOKIE_PREFIX" | "TOKEN_ENCRYPTION_KEY" | "TOKEN_SIGNING_KEY" | "RESEND_API_KEY" | "TURNSTILE_SECRET_KEY">> {}
}
