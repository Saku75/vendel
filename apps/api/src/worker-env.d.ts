/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings src/worker-env.d.ts` (hash: 83063f7531884b5a5221024c8327b798)
...
declare namespace Cloudflare {
	interface Env {
		...
		DB: D1Database;
		TOKEN_ENCRYPTION_KEY: SecretsStoreSecret;
		TOKEN_SIGNING_KEY: SecretsStoreSecret;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "API_ORIGIN" | "CORS_ORIGINS">> {}
}
