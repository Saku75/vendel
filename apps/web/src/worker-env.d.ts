/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings src/worker-env.d.ts` (hash: 238f6999239e20850c8fe00d4832d582)
...
declare namespace Cloudflare {
	...
	interface Env {
		MODE: "local" | "dev" | "prod";
		CANONICAL_ORIGIN: "http://localhost:5173" | "https://dev.vendel.dk" | "https://vendel.dk";
		COOKIE_PREFIX: "vendel_local" | "vendel_dev" | "vendel";
		TURNSTILE_SITE_KEY: "1x00000000000000000000AA" | "0x4AAAAAABh5FlLMz6Dpndqg" | "0x4AAAAAABh5GKQ74cdhLL-d";
		API: Fetcher /* vendel-api */;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MODE" | "CANONICAL_ORIGIN" | "COOKIE_PREFIX" | "TURNSTILE_SITE_KEY">> {}
}
