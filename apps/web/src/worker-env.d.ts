/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings src/worker-env.d.ts` (hash: dcf694a3171be19a75e7e96f624a4a2e)
// Runtime types generated with workerd@1.20260625.1 2025-11-17 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	ASSETS: Fetcher;
	MODE: "dev" | "prod" | "local";
	CANONICAL_ORIGIN: "https://dev.vendel.dk" | "https://vendel.dk" | "http://localhost:7000";
	COOKIE_PREFIX: "vendel_dev" | "vendel" | "vendel_local";
	TURNSTILE_SITE_KEY: "0x4AAAAAABh5FlLMz6Dpndqg" | "0x4AAAAAABh5GKQ74cdhLL-d" | "1x00000000000000000000AA";
	TOKEN_ENCRYPTION_KEY: string;
	TOKEN_SIGNING_KEY: string;
	API: Fetcher /* vendel-api-dev */ | Fetcher /* vendel-api-prod */ | Fetcher /* vendel-api */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MODE" | "CANONICAL_ORIGIN" | "COOKIE_PREFIX" | "TURNSTILE_SITE_KEY" | "TOKEN_ENCRYPTION_KEY" | "TOKEN_SIGNING_KEY">> {}
}
